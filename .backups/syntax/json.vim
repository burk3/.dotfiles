...
" Syntax: Strings {{{2
syn match  jsonString /"\([^\\"]\|\\.\)\{-1,}"\(\s*:\)\@!/ contains=jsonEscape
" Syntax: JSON uses doublequoted strings for object keys.
syn match  jsonStringKey /"\([^\\"]\|\\.\)\{-1,}"\(\s*:\)\@=/ contains=jsonEscape
